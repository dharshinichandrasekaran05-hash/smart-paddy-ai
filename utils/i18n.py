...
def get_treatment_table_labels(lang: str = DEFAULT_LANGUAGE) -> dict:
    """Return unique treatment headers without the legacy generic fallback."""
    lang = resolve_lang(lang)
    values = _TREATMENT_TABLE_LABELS.get(lang, _TREATMENT_TABLE_LABELS[DEFAULT_LANGUAGE])
